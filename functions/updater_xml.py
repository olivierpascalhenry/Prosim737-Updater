...
def create_updater_xml(self, out_file_name):
    logging.info('updater_xml.py - creation of the xml file ...')
    ...
    # Home page
    ############################
    logging.debug('updater_xml.py - home page options creation ...')
    ...
    # Server page
    ############################
    logging.debug('updater_xml.py - server page options creation ...')
    ...
    # MCP page
    ############################
    logging.debug('updater_xml.py - mcp page options creation ...')
    ...
    # CDU page
    ############################
    logging.debug('updater_xml.py - cdu page options creation ...')
    ...
    # Display page
    ############################
    logging.debug('updater_xml.py - display page options creation ...')
    ...
    # Panel page
    ############################
    logging.debug('updater_xml.py - panel page options creation ...')
    ...
    # Audio page
    ############################
    logging.debug('updater_xml.py - audio page options creation ...')
    ...
    # Credentials page
    ############################
    logging.debug('updater_xml.py - credential page options creation ...')
    ...
    # File Creation
    ############################
    logging.debug('updater_xml.py - file creation ...')
    f = open(out_file_name, 'w')
    f.write(doc.toprettyxml())
    f.close()
    self.saved = True
    self.modified = False
    logging.info('updater_xml.py - xml file successfully created')
    

def read_updater_xml(self, xml_file):
    logging.info('updater_xml.py - xml file reading in progress (' + str(xml_file) + ') ...')
    f = open(xml_file, 'r')
    ...
    # Home page
    ############################
    logging.debug('updater_xml.py - home page options reading ...')
    ...
    # MCP page
    ############################
    logging.debug('updater_xml.py - mcp page options reading ...')
    ...
    # CDU page
    ############################
    logging.debug('updater_xml.py - cdu page options reading ...')
    ...
    # Display page
    ############################
    logging.debug('updater_xml.py - display page options reading ...')
    ...
    for index, display in enumerate(display_list):
        if index == 0:
            self.display_ln_1.setText(display)
        else:
    ...
    # Panel page
    ############################
    logging.debug('updater_xml.py - panel page options reading ...')
    ...
    # Audio page
    ############################
    logging.debug('updater_xml.py - audio page options reading ...')
    ...
    # Credentials page
    ############################
    logging.debug('updater_xml.py - credential page options reading ...')
    ...
    logging.info('updater_xml.py - xml file successfully parsed')
