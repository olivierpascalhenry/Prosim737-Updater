...
"}")
        ...
        self.dw_downloadButton.setMaximumSize(QtCore.QSize(250, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.dw_cancelButton.setMaximumSize(QtCore.QSize(110, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.dw_quitButton = QtWidgets.QToolButton(downloadWindow)
        self.dw_quitButton.setMinimumSize(QtCore.QSize(90, 27))
        self.dw_quitButton.setMaximumSize(QtCore.QSize(110, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
    ...
    def retranslateUi(self, downloadWindow):
        ...
        self.dw_cancelButton.setText(_translate("downloadWindow", "Cancel"))
        self.dw_quitButton.setText(_translate("downloadWindow", "Quit"))
