...
class Ui_optionWindow(object):
    def setupUi(self, optionWindow):
        ...
        optionWindow.resize(702, 360)
        optionWindow.setMinimumSize(QtCore.QSize(700, 360))
        optionWindow.setMaximumSize(QtCore.QSize(702, 360))
        font = QtGui.QFont()
...
"}")
        ...
        self.gridLayout.addWidget(self.ow_label_3, 0, 0, 1, 1)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.ow_comboBox_2 = QtWidgets.QComboBox(optionWindow)
        self.ow_comboBox_2.setMinimumSize(QtCore.QSize(150, 27))
        self.ow_comboBox_2.setMaximumSize(QtCore.QSize(150, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(9)
        font.setBold(False)
...
"}")
        ...
        self.horizontalLayout_3.addWidget(self.ow_comboBox_2)
...
"}")
        ...
        self.gridLayout.addWidget(self.ow_label_1, 1, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.ow_label_2, 2, 0, 1, 1)
...
"}")
        ...
        self.horizontalLayout.addWidget(self.ow_lineEdit)
