...
"}")
        ...
        self.iw_nosaveButton.setMaximumSize(QtCore.QSize(220, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.iw_cancelButton.setMinimumSize(QtCore.QSize(90, 27))
        self.iw_cancelButton.setMaximumSize(QtCore.QSize(110, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.iw_saveButton.setMinimumSize(QtCore.QSize(90, 27))
        self.iw_saveButton.setMaximumSize(QtCore.QSize(110, 27))
        font = QtGui.QFont()
        font.setFamily("fonts/SourceSansPro-Regular.ttf")
        font.setPointSize(10)
        font.setBold(False)
