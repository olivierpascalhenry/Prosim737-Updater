...
"}")
    ...
    def retranslateUi(self, unpackWindow):
        ...
        self.dw_label_1.setText(_translate("unpackWindow", "<html><head/><body><p>Clic on the <span style=\" font-weight:600; font-style:italic; color:#0000c8;\">Unpack and Install</span> button to start unpacking the package. Installation process will start automatically once the package is extracted.</p><p align=\"center\"><span style=\" font-style:italic; color:#c80000;\">Warning ! Once the extraction is started, the process can\'t be stoped until install is complete.</span></p></body></html>"))
        self.label.setText(_translate("unpackWindow", "TEMP"))
        self.dw_downloadButton.setText(_translate("unpackWindow", "Unpack and Install"))
        self.dw_cancelButton.setText(_translate("unpackWindow", "Quit"))
